...
public interface AdminInterface {
     ...
     */
    boolean removeCourse(int courseId) throws CourseNotFoundException;
     ...
     */
    boolean approveStudentRequest(int studentId) throws StudentNotFoundException, StudentAlreadyApprovedException;
     ...
     */
    boolean addProfessor(String name, String emailId, String password, String phoneNo, String department, String designation) throws SQLException;
